...
public class UnicornEntityModel extends EntityModel<UnicornEntityRendererState> {

    protected final ModelPart F_leg_L;
    protected final ModelPart f_l_l_1;
    protected final ModelPart f_l_l_2;
    protected final ModelPart f_l_l_3;
    protected final ModelPart F_leg_R;
    protected final ModelPart f_l_r_1;
    protected final ModelPart f_l_r_2;
    protected final ModelPart f_l_r_3;
    protected final ModelPart Body;
    protected final ModelPart Tail;
    protected final ModelPart tail_1;
    protected final ModelPart tail_2;
    protected final ModelPart tail_3;
    protected final ModelPart tail_brush;
    protected final ModelPart B_leg_R;
    protected final ModelPart b_l_r_1;
    protected final ModelPart b_l_r_2;
    protected final ModelPart b_l_r_3;
    protected final ModelPart B_leg_L;
    protected final ModelPart b_l_l_1;
    protected final ModelPart b_l_l_2;
    protected final ModelPart b_l_l_3;
    protected final ModelPart neck_and_head;
    protected final ModelPart neck_1;
    protected final ModelPart neck_2;
